...
?>
  ...
  <div class="flex flex-col flex-auto flex-shrink-0 min-h-screen antialiased text-black bg-zinc-100 ">
            <div class="h-full  mb-10 ml-64 mt-14 md:ml-64 md:px-20 xl:px-12" style="padding-left: 400px;padding-right: 400px;">
                ...
                <form class="min-w-full p-10 pl-10  bg-purple-200 rounded-lg shadow-xl xl:px-10" method="post" action="">
                    <h1 class="mb-8 font-sans text-2xl font-bold text-center text-gray-600">Requirement Details</h1>
                            ...
                            {?>
                <div class="box-border bg-purple-100 mt-10 h-100 w-full p-4 border-4 rounded-lg">
