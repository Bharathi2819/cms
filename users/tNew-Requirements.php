                ...
                <form class="min-w-full p-10 pl-100  bg-white rounded-lg shadow-xl " method="post" action="" >
                    ...
                    <span> <ul class="flex  justify-end">
                                <div class="inline-flex rounded-md shadow-sm" role="group">
                                    <button type="button" value="Requirement"  onclick="document.location.href='tNew-Requirements.php'" checked class="px-4 py-2 text-sm font-bold  text-white bg-gradient-to-r from-pink-500 via-pink-500 to-pink-500 hover:bg-gradient-to-br  focus:ring-pink-500 dark:focus:ring-pink-500 bg-white border-2 border-pink-500 rounded-l-lg ">
                                    Material
                                    </button>
                                    <button type="button" value="Fund" onclick="document.location.href='tNew-Fund.php'" class="px-6 py-2 text-sm font-bold text-sky-800 bg-gradient-to-r from-white-100 via-white-200 rounded-r-md to-white-300 hover:bg-gradient-to-br  dark:focus:text-white  dark:focus:ring-white-300 bg-white border-2 border-white-400 ">
                                    Fund
                                    </button>
                                </div>
                            </ul></span>
