            ...
            <div class="h-full  mb-50 ml-64 mt-20 md:ml-64 md:px-20 xl:px-12 " >
                ...
                <ul class="flex items-center justify-end">
                                <div class="inline-flex rounded-md shadow-sm" role="group">
                                    <button type="button" value="Requirement"  onclick="document.location.href='tHolded-Requirements.php'" checked class="px-4 py-2 text-sm font-semibold  text-white bg-gradient-to-r from-pink-500 via-pink-500 to-pink-500 hover:bg-gradient-to-br  focus:ring-pink-500  bg-white border-2 border-pink-500 rounded-l-lg ">
                                    Material
                                    </button>
                                    <button type="button" value="Fund" onclick="document.location.href='tHolded-Fund.php'" class="px-6 py-2 text-sm font-semibold text-sky-800 bg-gradient-to-r from-white-100 via-white-200 rounded-r-md to-white-300 hover:bg-gradient-to-br  focus:ring-white-200  bg-white border-2 border-white-400 ">
                                    Fund
                                    </button>
                                </div>
                            </ul>
