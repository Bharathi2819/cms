                                        ...
                                        <tr>
                                            ...
                                            <button type="button" class="px-7 py-1.5 text-start text-sm font-semibold text-red-600 bg-red-200 rounded-full">Not Process Yet</button>
                                                <?php }
                                                    if($status=="approve"){ 
                                                ?>
                                            <button type="button" class="px-12 py-1.5 text-start text-sm font-semibold text-green-600 bg-green-200 rounded-full">Approve</button>
                                                <?php }
                                                    if($status=="hold") {
                                                ?>
                                            <button type="button" class="px-14 py-1.5 text-start text-sm font-semibold text-yellow-600 bg-yellow-200 rounded-full">Hold</button>
                                            <?php }
                                                    if($status=="reject") {
                                                ?>
