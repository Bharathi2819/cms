                    ...
                    <form class=" h-100 p-14 bg-white rounded-lg " method="post" action="" >
                        ...
                        <div class="grid  grid-cols-1 gap-8 xl:grid-cols-4">
                            ...
                            <div>
                                ...
                                <div>
                                    <button type="submit" name="submit" class="px-4 py-2 mt-10 font-sans text-lg font-semibold tracking-wide text-white bg-pink-500 rounded-lg hover:bg-sky-800">Submit</button>
                                </div>
                            </div>
                    </form>
                </div>
