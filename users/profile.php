                    ...
                    <form class=" h-100 p-14 bg-white rounded-lg " method="post" action="" >
                        ...
                        <div class="grid  grid-cols-1 gap-8 xl:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input class="w-full px-4 py-2 rounded-lg bg-zinc-100 focus:outline-none" type="text" name="designation"  text-gray-600 value="<?php echo htmlentities($row['Description']);?>" placeholder="Description"required />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div>
                                    <button type="submit" name="submit" class="px-4 py-2 mt-10 font-sans text-lg font-semibold tracking-wide text-white bg-amber-400 rounded-lg hover:bg-sky-800">Submit</button>
                                </div>
                            </div>
                    </form>
                </div>
