...
<body>
            <div class="h-full  mb-50 ml-64 mt-20 md:ml-64 md:px-20 xl:px-12 " style="padding-left: 150px;padding-right: 150px;">
                ...
                <h1 class="mb-10 font-sans text-2xl font-bold text-center uppercase text-purple-600 ">Material Rejected</h1>
                <ul class="flex items-center justify-end">
                                <div class="inline-flex rounded-md shadow-sm" role="group">
                                    <button type="button" value="Requirement"  onclick="document.location.href='tRejected-Requirement.php'" checked class="px-4 py-2 text-sm font-semibold  text-black bg-gradient-to-r from-purple-100 via-purple-200 to-purple-300 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-300 bg-white border-2 border-purple-400 rounded-l-lg ">
                                    Material
                                    </button>
                                    <button type="button" value="Fund" onclick="document.location.href='tRejected-Fund.php'" class="px-6 py-2 text-sm font-semibold text-black bg-gradient-to-r from-white-100 via-white-200 rounded-r-md to-white-300 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-white-200   dark:focus:text-white  dark:focus:ring-white-300 bg-white border-2 border-white-400 ">
                                    Fund
                                    </button>
                                </div>
                            </ul>
                            ...
                            <div class="my-10 bg-white rounded shadow-md">
                                ...
                                ?>
										...
										<tr>
                                            ...
                                            <td><button type="button" class="px-6 py-1.5 text-sm font-semibold text-red-600 bg-red-200 rounded-full">Rejected</button></td>
											<td>
                                            <a href="tmaterial-details.php?cid=<?php echo htmlentities($row['reqNumber']);?>"  class="px-4 py-1.5 text-sm font-semibold text-purple-600 bg-purple-200 rounded-full">View Details
