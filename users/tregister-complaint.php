...
if ($_SESSION['role'] != 'admin') {
    ...
    if (isset($_POST['submit'])) {
      ...
      $query = mysqli_query($conn, "insert into tblcomplaints(userId,category,subcategory,complaintType,complainasset,ExpiryDate,complaintDetails,department,departmentcode,state,location,place,branchcode,complaintFile) values('$uid','$category','$subcat','$complaintype','$complainasset','$Description','$complaintdetials','$department','$departmentcode','$state','$location','$place','$branchcode','$compfile')");
      if ($query) {
                       ...
                       <?php
                        ...
                        <div class="grid grid-cols-3 place-content-center">
                            <div>
                                ...
                                <input  type="file" name="compfile" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-purple-400 file:text-purple-50 " value=""/>
                            </div>
                        </div>
