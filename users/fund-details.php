        ...
        <div class="flex flex-col flex-auto flex-shrink-0 min-h-screen antialiased text-black bg-zinc-100 ">
            <div class="h-full  mb-10 ml-64 mt-14 md:ml-64 md:px-20 xl:px-12" style="padding-left: 400px;padding-right: 400px;">
                ...
                <form class="min-w-full p-10 pl-10  bg-gray-200 rounded-lg shadow-xl xl:px-10" method="post" action="">
                    <h1 class="mb-8 font-sans text-2xl font-bold text-center text-gray-600">Fund Details</h1>
                    <?php
                                $query=mysqli_query($conn,"select * from fund where userId='".$_SESSION['id']."' and fundNumber='".$_GET['cid']."'");
                                while($row=mysqli_fetch_array($query))
                            {?>
                <div class="box-border  bg-gray-200  mt-10 h-100 w-full p-4 border-4 rounded-lg">
                    <div class="ml-24 grid grid-cols-1 gap-2 xl:grid-cols-2">
                        <label class="block my-2 font-semibold text-gray-800 text-md"><b>Fund Number </b></label>
                        ...
                        <label class="block my-3 font-semibold text-gray-800 text-md"><b>Fund Type </b></label>
                        <div class="block my-3 font-semibold text-gray-800 text-md">
                        ...
                        <label class="block my-3 font-semibold text-gray-800 text-md"><b>Fund Details: </label>
                        <div class="block my-3 font-semibold text-gray-800 text-md">
