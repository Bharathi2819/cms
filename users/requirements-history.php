...
?>
  <div class="h-full  mb-30 ml-64 mt-20 md:ml-64 md:px-20 xl:px-12 " >
                ...
                <form class="min-w-full p-10 pl-100  bg-white rounded-lg shadow-xl " method="post" action="" >
                    <h1 class="mb-3 font-sans text-2xl font-bold text-center uppercase text-sky-800 ">Material History</h1>
                                        ...
                                        <tr>
                                            ...
                                            <button type="button"  class="px-12 py-1.5 text-start text-sm font-semibold text-green-600 bg-green-200 rounded-full">Approved</button>
                                                <?php }
                                                    if($status=="Hold") {
                                                ?>
                                            <button type="button"class="px-16 py-1.5 text-start text-sm font-semibold text-yellow-600 bg-yellow-200 rounded-full" >Holded</button>
                                            <?php }
                                                    if($status=="Rejected") {
                                                ?>
                                            ...
                                            <td class="px-6 py-3 text-center">
                                                <a href="requirements-details.php?cid=<?php echo htmlentities($row['reqNumber']);?>">
