...
<body>
            ...
            ?>
            <div class="h-50  mb-20 ml-64 mt-20 md:ml-64 md:px-20 xl:px-12">
                ...
                <form class="min-w-full p-10 pl-100  bg-white rounded-lg shadow-xl " method="post" action="" >
                    <h1 class="font-sans text-2xl font-bold text-center uppercase text-sky-800 ">Not Process complaints</h1>
