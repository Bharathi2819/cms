...
<body>
            ...
            ?>
            <div class="h-50  mb-50 ml-64 mt-20 md:ml-64 md:px-20 xl:px-12 mb-10 " style="padding-left: 150px;padding-right: 150px;">
                ...
                <form class="min-w-full p-20 pl-100  bg-white rounded-lg shadow-xl " method="post" action="" >
                    <h1 class="mb-10 font-sans text-2xl font-bold text-center uppercase text-sky-600 ">Not Process complaints</h1>
                        ...
                        <div class="w-full lg:w-6/6">
                            <div class=" bg-white rounded shadow-md">
                                <table class="w-full table-auto min-w-max">
                                    ...
                                    <?php 
                                        $query=mysqli_query($conn,"select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status is null  LIMIT $start_from, $per_page_record ");
									...
									<tbody class="text-base  text-black font-semibold  even:bg-white-100 odd:bg-sky-50">
										<tr>
											...
											<td>
                                                <a href="complaint-details.php?cid=<?php echo htmlentities($row['complaintNumber']);?>"  class="px-4 py-1.5 text-sm font-semibold text-purple-600 bg-purple-200 rounded-full">View Details</a>
                                            </td>
                                        </tr>
										 <?php  } ?>
                                    </tbody>
                            ...
                            <div class="flex justify-center mt-10">
                                ...
                                $total_records_query = "SELECT COUNT(*) FROM tblcomplaints where tblcomplaints.status is null ";
