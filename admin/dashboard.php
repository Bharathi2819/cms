...
<div class="flex flex-col flex-auto flex-shrink-0 min-h-screen antialiased text-black bg-gray-100">
    ...
    <?php
       ...
       $rt_material = mysqli_query($conn, "SELECT COUNT(*) AS num_new FROM requirements JOIN users ON users.id = requirements.userId WHERE requirements.status IS NULL  AND requirements.regDate BETWEEN '" . $last_week . "' AND '" . $today . "'");
