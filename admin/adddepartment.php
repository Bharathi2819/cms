                        ...
                        <div class="w-full lg:w-6/6">
                            <div class="my-10 bg-white rounded shadow-md">
                                <table class="w-full table-auto min-w-max">
                                    ...
                                    <?php $query=mysqli_query($conn,"select * from state LIMIT $start_from, $per_page_record ");
                                        $cnt=1;
                                    ...
                                    <tbody class="text-base  text-black font-semibold  even:bg-white-100 odd:bg-sky-50">
                                        <tr >
											...
											<td class="px-6 py-3 text-start" ><?php echo htmlentities($row['stateName']);?></td>
											<td class="px-6 py-3 text-start"><?php echo htmlentities($row['stateDescription']);?></td>
											<td class="px-6 py-3 text-start"> <?php echo htmlentities($row['postingDate']);?></td>
											<td class="px-6 py-3 text-start"><?php echo htmlentities($row['updationDate']);?></td>
                                            <td class="px-6 py-3 text-start">
                                                <div class="flex justify-center item-center">
                                                    <a href="adedit.php?id=<?php echo $row['id']?>" class="w-5 mr-4 transform text-green-500 hover:text-green-800 hover:scale-110">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                                        </svg>
                                                    </a>
                                                    <a href="adddepartment.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="w-5 mr-2 transform text-red-500 hover:text-red-800 hover:scale-110">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
