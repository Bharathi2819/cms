...
<body>
            <div class="h-full  mb-50 ml-64 mt-20 md:ml-64 md:px-20 xl:px-12 " style="padding-left: 150px;padding-right: 150px;">
                ...
                <form class="min-w-full p-20 pl-100  bg-white rounded-lg shadow-xl " method="post" action="" >
                    <h1 class="mb-10 font-sans text-2xl font-bold text-center uppercase text-sky-600 ">Holded-Fund</h1>
                            ...
                            <div class="my-10 bg-white rounded shadow-md">
                                ...
                                ?>
										...
										<tr>
											...
											<td>
                                            <a href="tfund-details.php?cid=<?php echo htmlentities($row['reqNumber']);?>"  class="px-6 py-1.5 text-sm font-semibold text-sky-600 bg-sky-200 rounded-full">View Details
