                            ...
                            <div class="my-10 bg-white rounded shadow-md">
                                ...
                                ?>
										...
										<tr>
											...
											<td>
                                            <a href="tmaterial-details.php?cid=<?php echo htmlentities($row['reqNumber']);?>"  class="px-6 py-1.5 text-sm font-semibold text-sky-600 bg-sky-200 rounded-full">View Details
