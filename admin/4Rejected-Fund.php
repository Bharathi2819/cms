                        ...
                        <div class="w-full lg:w-6/6">
                            <div class="my-10 bg-white rounded shadow-md">
                                <table class="w-full table-auto min-w-max">
                                  ...
                                  WHERE 
                                  fund.status ='Rejected' LIMIT $start_from, $per_page_record");
                                ...
                                ?>
										...
										<tr>
											...
											<td>
                                            <a href="tfund-details.php?cid=<?php echo htmlentities($row['fundNumber']);?>"  class="px-4 py-1.5 text-sm font-semibold text-sky-600 bg-sky-200 rounded-full">View Details
                                ...
                                $total_records_query = "SELECT COUNT(*) FROM fund 
                                WHERE 
