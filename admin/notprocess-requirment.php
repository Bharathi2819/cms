                        ...
                        <div class="w-full lg:w-6/6">
                            <div class="my-10 bg-white rounded shadow-md">
                                <table class="w-full table-auto min-w-max">
                                    ...
                                    <?php 
$query=mysqli_query($conn,"select requirements.*,users.fullName as name from requirements join users on users.id=requirements.userId where requirements.status is null ");
...
?>										
										...
										<tr>
                                            ...
                                            <a href="requirements-details.php?cid=<?php echo htmlentities($row['reqNumber']);?>"  class="px-4 py-1.5 text-sm font-semibold text-purple-600 bg-purple-200 rounded-full">View Details
