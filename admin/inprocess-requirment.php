...
<body>
            ...
            <div class="h-full  mb-50 ml-64 mt-20 md:ml-64 md:px-20 xl:px-12 " style="padding-left: 150px;padding-right: 150px;">
                ...
                <form class="min-w-full p-20 pl-100  bg-white rounded-lg shadow-xl " method="post" action="" >
                    <h1 class="mb-10 font-sans text-2xl font-bold text-center uppercase text-sky-600 ">Inprocess Requirment</h1>
...
{
?>		<tbody class="text-sm  text-black-800 even:bg-white-100 odd:bg-sky-50">	
										<tr>
                                            ...
                                            <td><button type="button" class="px-7 py-1.5 text-start text-sm text-yellow-600 bg-yellow-200 rounded-full">IN Process</button></td>
											<td>

                                            <a href="requirements-details.php?cid=<?php echo htmlentities($row['reqNumber']);?>"  class="px-3 py-1 text-start text-xs text-purple-600 bg-purple-200 rounded-full">View Details
